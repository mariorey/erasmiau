    ...
    return (
        <section className="relative h-screen w-full overflow-hidden">
            ...
            <div className="relative z-10 flex h-full flex-col items-center justify-center text-center px-4">
                ...
                {/* Título */}
                <h1 className="text-white text-5xl md:text-6xl font-bold tracking-widest uppercase mb-6">
                    Erasmiau Youth
                    <br />
                    Association
                </h1>
                ...
                {/* Subtítulo */}
                <p className="text-white/90 text-xl md:text-2xl italic font-light mb-10">
