...
import type { ImageBlock as ImageBlockType } from "@/types/content"
...
export function ImageBlock({ src, alt = "", caption, aspectRatio = "auto", rounded, priority }: ImageBlockType) {
