...
// Photo naming convention (upload to /public/images/projects/hosting/):
//   dyst-1.jpeg   – Cyprus flag       (NECI)
//   dyst-2.jpeg   – Albania flag      (Perspektiva)
//   dyst-3.jpeg   – Armenia flag      (ABCD)
//   dyst-4.jpeg   – Bulgaria flag     (Re-Act)
//   dyst-5.jpeg   – Croatia flag      (EUTOPIA)
//   dyst-6.jpeg   – Greece flag       (EKO)
//   dyst-7.jpeg   – Italy flag        (M.Y. CULTURE)
//   dyst-8.jpeg   – Portugal flag     (Experimentaculo)
//   dyst-9.jpeg   – Romania flag      (ATIC)
//   dyst-10.jpeg  – Spain flag        (Erasmiau)
//   dyst-11.jpeg  – Day 1 photo
//   dyst-12.jpeg  – Day 2 photo
//   dyst-13.jpeg  – Day 3 photo
//   dyst-14.jpeg  – Day 4 photo
//   dyst-15.jpeg  – Day 5 photo
//   dyst-16.jpeg  – Day 6 photo
//   dyst-17.jpeg  – Day 7 photo
...
const content: PageContent = {
  ...
  heroImage: `${BASE}/hosting-2-cover.jpg`,
  sections: [
    // ── 1. Description ────────────────────────────────────────────────────────
    {
      layout: "single",
...
🍔 Farewell Dinner: As night fell, we ventured to the charming Nolitos Burger for our Farewell Dinner. In a cozy atmosphere, we watched the results of "Youth in Action" activity. The evening was a perfect blend of joy, happiness and delicious food, creating lasting memories that will be cherished by all of us! ❤️`,
    ...
    // ── 4. Photo Album ────────────────────────────────────────────────────────
    {
      ...
      images: [
        ...
        { src: p(31), alt: "Photo 13" },
        { src: p(32), alt: "Photo 14" },
        { src: p(33), alt: "Photo 15" },
        { src: p(34), alt: "Photo 16" },
      ],
    },
  ],
}
