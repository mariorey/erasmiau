...
const B = "/images/projects/hosting/rythm"
...
const p: Record<number, string> = {
  ...
  5:  `${B}/5.png`,   // Spain
  6:  `${B}/6.png`,   // Ukraine
  // Daily report photos (one per day)
  7:  `${B}/7.jpg`,   // Day 1
  8:  `${B}/8.jpg`,   // Day 2
  9:  `${B}/9.jpg`,   // Day 3
  10: `${B}/10.jpg`,  // Day 4
...
const content: PageContent = {
  ...
  sections: [
    ...
    // ── 2. Partner organisations (6 partners → 6-column row) ─────────────────
    {
      layout: "autoGrid",
      count: 6,
      background: "light",
...
In the afternoon we went to have dinner in other place. We had the pleasure to try delicious pizzas while talking with all the participants. After the dinner, we did the YouthPass Ceremony, it was such a magical moment. We all felt that we became a big family ❤️`,
    ...
    // ── 4. Photo Album (12 photos, 4 columns → 3 rows) ───────────────────────
    {
      layout: "gallery",
      background: "light",
      paddingY: "lg",
